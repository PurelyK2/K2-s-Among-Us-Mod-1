...
{
    internal static ManualLogSource LocaleLogger { get; } = BepInEx.Logging.Logger.CreateLogSource("K2AndNullLocale");
    ...
    public static void SearchInternalLocale()
    {
        ...
        foreach (var locale in TouLocale.LangList)
        {
            using var resourceStream =
                assembly.GetManifestResourceStream("K2AndNull.Resources.Locale." + locale.Value);
